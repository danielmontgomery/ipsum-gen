function runIt(){
	...
	for(var counter = 0; counter < paragraphNum; counter++){
		for(var x = 0; x < paragraphLength; x++){
			var wordsArray = ["java", "javascript", "computer", "HTML", "may I invite you to", "jobs", "GA", "happy hour", "chrome", "firefox", "variable", "mac", "unix", "tab", "function", "boring", "redefine", "console.log", "comment", "inspect element", "engineering", "networks", "Internet", "data", "file", "hacking", "science", "software", "web browser", "website", "doctype", "angularJS", "strong drink", "hot damn", "karaoke", "let's get that set up", "we're gonna kick it's ass", "be committed, but not attached", "slackjaw", "party on some code", "for our next trick...", "shit", "fuck", "let's hack this", "rails", "wdi", "infinite loop", "alert", "submlime", "damn", "beeeeeeeer", "meeeeaat", "this floats my biscuit", "this is the best day of my life", "this is the worst day of my life", "woah", "first person who saw an elephant was pretty perplexed", "butthole unscathed", "that's janked", "all dressed up and nowhere to go","I hate it with the fire of 1000 suns", "I want you to pick your poison"];
